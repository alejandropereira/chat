...
function login(callback, options) {
  ...
  if (runningInCordova) {
    ...
    loginWindow.addEventListener('loadstart', show_loading);
    loginWindow.addEventListener('loadstop', hide_loading);
    loginWindow.addEventListener('loaderror', hide_loading);
